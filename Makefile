...
.PHONY: all visual audio render sample preview sounds clean help

help:
	@echo "Rain-sounds pipeline targets:"
	@echo "  make visual   - build the seamless looping visual (build/loop_visual.mp4)"
	@echo "  make audio    - build the seamless looping audio  (build/loop_audio.m4a)"
	...
	@echo "  make sounds   - render a 20s preview of every sound (output/previews/)"
